...
export class Migration20230824075818 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'create table "products" ("id" uuid not null, "created" timestamptz(0) not null, "updated" timestamptz(0) not null, "name" varchar(255) not null, "price" int not null, "description" varchar(255) not null, "image_url" varchar(255) not null, "quantity" int not null, "category" text check ("category" in (\'beer\', \'snacks\', \'accessories\')) not null, "type" text check ("type" in (\'Ale\', \'Lager\', \'Wheat Beer\', \'Pretzels\', \'Nachos\', \'Spicy Wings\', \'Beer Glasses\', \'Bottle Opener\', \'Beer Coasters\')) not null, "archived" boolean not null default false, "descr" text check ("descr" in (\'product\', \'accessory\', \'beer\', \'snacks\')) not null, "abv" int null, "country" varchar(255) null, "volume" int null, "ibu" int null, "weight" int null, constraint "products_pkey" primary key ("id"));',
    );

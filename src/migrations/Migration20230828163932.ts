...
export class Migration20230828163932 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "reviews" ("id" uuid not null, "created" timestamptz(0) not null, "updated" timestamptz(0) not null, "summary" varchar(255) not null, "text" varchar(255) not null, "rating" int not null, "edited" boolean not null, "archived" boolean not null, "user_id" uuid not null, "product_id" uuid not null, constraint "reviews_pkey" primary key ("id"));',
    );

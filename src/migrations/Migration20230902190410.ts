...
export class Migration20230902190410 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "order_product_entity" ("id" uuid not null, "created" timestamptz(0) not null, "updated" timestamptz(0) not null, "name" varchar(255) not null, "description" varchar(255) not null, "category" varchar(255) not null, "image_url" varchar(255) not null, "price" int not null, "quantity" int not null, "order_id" uuid not null, "product_id" varchar(255) not null, constraint "order_product_entity_pkey" primary key ("id"));',
    );
